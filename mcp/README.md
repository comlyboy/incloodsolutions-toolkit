...
[![npm version](https://img.shields.io/npm/v/@incloodsolutions/mcp.svg?style=for-the-badge)](https://www.npmjs.com/package/@incloodsolutions/mcp)
[![npm downloads](https://img.shields.io/npm/dm/@incloodsolutions/mcp.svg?style=for-the-badge)](https://www.npmjs.com/package/@incloodsolutions/mcp)
[![total downloads](https://img.shields.io/npm/dt/@incloodsolutions/mcp.svg?style=for-the-badge)](https://www.npmjs.com/package/@incloodsolutions/mcp)
[![license](https://img.shields.io/npm/l/@incloodsolutions/mcp.svg?style=for-the-badge)](https://www.npmjs.com/package/@incloodsolutions/mcp)

A lightweight, framework-agnostic utility library providing the shared functions, validation
schemas, error primitives, and TypeScript types used across every IncloodSolutions mcp.
...
```bash
npm install @incloodsolutions/mcp
# or
yarn add @incloodsolutions/mcp
# or
pnpm add @incloodsolutions/mcp
```
...
```typescript
// ESM
import { generateNanoid } from '@incloodsolutions/mcp';

// CommonJS
const { generateNanoid } = require('@incloodsolutions/mcp');
```
...
```typescript
import { CustomException, ResponseMessageEnum } from '@incloodsolutions/mcp';
...
```typescript
import { CustomException } from '@incloodsolutions/mcp';
...
```typescript
import { sanitizeObject, transformText, generateRandomId } from '@incloodsolutions/mcp';
...
```typescript
import { isStrongPassword, normalizeEmail } from '@incloodsolutions/mcp';
...
```typescript
import type { IBaseId, IBaseCreator } from '@incloodsolutions/mcp';
import { AppEnvironmentEnum } from '@incloodsolutions/mcp';
...
npm test           # vitest run — behaviour tests for every export (test/mcp.spec.ts)
npm run test:watch # vitest in watch mode
npm run package    # build, then npm pack a tarball
```

[`test/mcp.spec.ts`](./test/mcp.spec.ts) exercises the whole public surface. Only
...
to the `publish-mcp` branch bumps through the pipeline, which refuses to republish an
...
[MIT](https://www.npmjs.com/package/@incloodsolutions/mcp) © Inclood Solutions
